...
from megatron.model.layerwise_bert import LayerwiseBertModel
...
def model_provider():
    ...
    print_rank_0('building Layerwise BERT model ...')

    model = LayerwiseBertModel(
        num_tokentypes=2,
...
def get_batch(data_iterator):
    ...
    datatype = torch.int64 # pylint: disable=no-member
